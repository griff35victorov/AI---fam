...
- Local automated test suite: 52 passing tests.

## Not Implemented Yet

- Real PostgreSQL persistence and migrations.
- Real Telegram sendMessage/webhook registration.
- Production startup wiring for real Timeweb AI env vars and agent IDs.
...
2. Add production runtime factory for Timeweb AI env vars and agent IDs.
...
5. Add web cabinet for owner and teacher workflows.
